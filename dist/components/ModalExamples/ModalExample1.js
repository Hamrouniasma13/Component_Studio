...
function (_React$Component) {
  _inherits(ModalExample1, _React$Component);

  function ModalExample1(props) {
    var _this;

    _classCallCheck(this, ModalExample1);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ModalExample1).call(this, props));
    _this.state = {
      isOpen: false
    };
