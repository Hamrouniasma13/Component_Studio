...
function (_React$Component) {
  _inherits(ModalExample2, _React$Component);

  function ModalExample2(props) {
    var _this;

    _classCallCheck(this, ModalExample2);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ModalExample2).call(this, props));
    _this.state = {
      isOpen: false
    };
  ...
  _createClass(ModalExample2, [{
    ...
    value: function render() {
      ...
      }, "Click me"), _react["default"].createElement(_Modal["default"], {
        isOpen: isOpen,
...
ModalExample2.defaultProps = {
  noOverlay: false,
  isOpen: false
};
var _default = ModalExample2;
