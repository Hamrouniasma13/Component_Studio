...
function (_React$Component) {
  _inherits(ModalExample3, _React$Component);

  function ModalExample3(props) {
    var _this;

    _classCallCheck(this, ModalExample3);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ModalExample3).call(this, props));
    _this.state = {
      isOpen: false
    };
